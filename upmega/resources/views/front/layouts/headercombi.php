...
<div class="header-area @if(Route::is('home') || Route::is('homepage')) landing-page-header @else @endif" id="headerArea">
   <div class="container-fluid h-100 d-flex align-items-center justify-content-between">
      ...
      <div class="logo-wrapper">
         ...
         <img class="img-fluid" src="https://www.upmega.co.ke/wp-content/uploads/upmega-logo-inverted-92.png"></a>
