...
<ul class="nav nav-pills nav-fill mb-3" id="pills-tab" role="tablist">
      ...
      <button class="nav-link upmega-bold nav-link-mobile active shadow-none upmega-reg-toggle-sign" id="login-upmega-init-tab" data-bs-toggle="pill" data-bs-target="#login-upmega-init" type="button" role="tab" aria-controls="login-upmega-init" aria-selected="true"><i class="fas fa-sign-in"></i> Login</button>
   </li>
   <li class="nav-item" role="presentation">
      <button class="nav-link upmega-bold nav-link-mobile shadow-none" id="reg-upmega-account-tab" data-bs-toggle="pill" data-bs-target="#reg-upmega-account" type="button" role="tab" aria-controls="reg-upmega-account" aria-selected="false"><i class="fa fa-user-circle"></i> Create Account</button>
   </li>
</ul>
<div class="tab-content" id="pills-tabContent">
   <div class="tab-pane" id="reg-upmega-account" role="tabpanel" aria-labelledby="reg-upmega-account-tab" tabindex="0">
   ...
   <div class="tab-pane show active" id="login-upmega-init" role="tabpanel" aria-labelledby="login-upmega-init-tab" tabindex="0">
      <form id="upmega-login-form" method="POST" action="{{ route('login') }}" autocomplete="off">
         ...
         <div class="form-button-group mt-2">
            <div class="d-grid gap-2">
                      <input onClick="this.form.submit(); this.disabled=true; this.value='Logging you in...';" type="submit" class="btn btn-primary border-0 btn-lg upmega-round w-100 font-weight-bold" value="Login" />
            </div>
         </div>
      </form>
   </div>
