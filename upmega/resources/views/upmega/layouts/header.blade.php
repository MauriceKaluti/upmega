   ...
   <div class="container-fluid d-flex align-items-center justify-content-between">
      <nav id="navbar" class="navbar text-start">
         <ul>
            ...
            <li><a class="nav-link upmega-bold" href="{{url('/home')}}">Home</a></li>
            <?php 
               $top_cats = App\Models\Category::get();
               ?>
            <li class="dropdown megamenu">
               <a class="upmega-bold" href="{{url('/shop')}}"><span>Our Sofas</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
               <ul class="shadow-lg">
            ...
            <li><a class="nav-link upmega-bold" href="{{url('/cart')}}">Cart</a></li>
            <!--   <li class="dropdown megamenu">
            ...
            <li><a class="nav-link upmega-bold" href="{{url('/')}}">Contact</a></li>
            <li><a class="nav-link upmega-bold" href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#toggleSideNav" aria-controls="toggleSideNav">My Account</a></li>
         </ul>
...
<div class="fixed-top mobile-topper">
   <div class="col-md-12 bg-white clearfix">
      <div class="float-start">
         <a href="{{url('/')}}">
         <img width="137.55" height="50.9" class="img-fluid" src="https://codekali.com/upmega/images/logo-dark.png">  
         </a>
      </div>
      <div class="float-end mt-2">
         ...
         <a id="cartCount2" class="text-dark upmega-bold me-2" href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#toggleCartNav" aria-controls="toggleCartNav">
         <span class="position-relative me-1">
         <i class="fa fa-shopping-cart fs-3"></i> 
         <span class="badge badge-primary bg-secondary upmega-round position-absolute top-0 start-100 translate-middle text-white border border-light rounded" style="font-size: .50em!important; border-radius: 30px!important;"> {{Cart::count()}}</span>
         </span> 
   ...
   <ul class="scrollmenu shadow-lg p-0 mb-0">
...
<div class="offcanvas offcanvas-end upmega-bg" data-bs-backdrop="true" data-bs-scroll="true" tabindex="-1" id="toggleCartNav"  aria-labelledby="toggleCartNavLabel">
   ...
   <div class="offcanvas-body p-1" id="sideCart">
         ...
         <table class="row-border stripe" style="width:100%">
            ...
            <tbody>
               ...
               <tr class="cart-row">
                  ...
                  <td class="std-font">
                     <span>{{ number_format($cartItem->price) }} x {{$cartItem->qty}}   <form action="{{route('cart.destroy',$cartItem->rowId)}}" method="POST">
                        {{csrf_field()}}
                        {{method_field('DELETE')}}
      ...
      @else
      <p><a class="upmega-text-secondary" href="{{url('/shop')}}"> <i class="fa fa-shopping-cart"></i> Shop Now </a> To Fill Your Basket</p>
      @endif
      <hr>
      <div class="text-center mb-3 mt-3">
         ...
         <?php 
            ...
            ?>
         @if(!empty($items))
         <a target="_blank" href="https://wa.me/254700422699?text=Hello%20Upmega%20Furniture,%20I'm%20interested%20in%20purchasing%20the%20following%20products+{{$items}}" class="btn btn-primary btn-lg upmega-round mb-3 w-100"><i class="fa fa-whatsapp"></i> Whatsapp Order</a>
         <a class="btn btn-secondary btn-lg w-100 upmega-round" href="{{url('/cart')}}"><i class="fa fa-shopping-cart"></i> Checkout</a>
         @else
